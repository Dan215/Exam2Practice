...
def run_test_practice_problem2a():
    ...
    seq = [0,1,2]
    delta = 1
    print('test 1:', practice_problem2a(seq, delta), "should be [1,2,3]")

    #Test 2
    seq = [0,1,2]
    delta = -1
    print('test 2:', practice_problem2a(seq, delta), "should be [-1,0,1]")

    #Test 3
    seq = [31, 81, 24, 234]
    delta = 10
    print('test 3:', practice_problem2a(seq, delta), "should be [41,91,34, 244]")

    #Test 4
    seq = []
    delta = 9001
    print('test 4:', practice_problem2a(seq, delta), "should be []")
